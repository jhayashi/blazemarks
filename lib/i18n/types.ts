...
export interface Translations {
  ...
  "settings.showMnemonic": string;
  "settings.hideMnemonic": string;
  "settings.restoreOwner": string;
  "settings.resetOwner": string;
  "settings.toastBookmarkletCopied": string;
  "settings.confirmReset": string;
  "settings.invalidMnemonic": string;
  "settings.enterMnemonic": string;
