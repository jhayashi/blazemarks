...
const de: Translations = {
  ...
  "settings.showMnemonic": "Mnemonic anzeigen",
  "settings.hideMnemonic": "Mnemonic verbergen",
  "settings.restoreOwner": "Eigentümer wiederherstellen",
  "settings.resetOwner": "Eigentümer zurücksetzen",
  ...
  "settings.invalidMnemonic":
    "Ungültiges Mnemonic. Bitte überprüfe es und versuche es erneut.",
  "settings.enterMnemonic": "Gib dein Mnemonic ein:",
