...
const ar: Translations = {
  ...
  "settings.showMnemonic": "إظهار العبارة التذكيرية",
  "settings.hideMnemonic": "إخفاء العبارة التذكيرية",
  "settings.restoreOwner": "استعادة المالك",
  "settings.resetOwner": "إعادة تعيين المالك",
  ...
  "settings.invalidMnemonic":
    "العبارة التذكيرية غير صالحة. يرجى التحقق والمحاولة مرة أخرى.",
  "settings.enterMnemonic": "أدخل العبارة التذكيرية:",
