...
const ko: Translations = {
  ...
  "settings.account": "계정",
  "settings.showIdentityPhrase": "신원 구문 표시",
  "settings.hideIdentityPhrase": "신원 구문 숨기기",
  "settings.restoreIdentity": "신원 복원",
  "settings.resetAllData": "모든 데이터 초기화",
  ...
  "settings.invalidIdentityPhrase":
    "유효하지 않은 신원 구문입니다. 확인 후 다시 시도해 주세요.",
  "settings.enterIdentityPhrase": "24단어 신원 구문을 입력하세요:",
  "settings.sync": "동기화",
