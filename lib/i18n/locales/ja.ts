...
const ja: Translations = {
  ...
  "settings.showIdentityPhrase": "識別フレーズを表示",
  "settings.hideIdentityPhrase": "識別フレーズを非表示",
  "settings.restoreIdentity": "識別情報を復元",
  ...
  "settings.invalidIdentityPhrase":
    "無効な識別フレーズです。確認してもう一度お試しください。",
  "settings.enterIdentityPhrase": "24単語の識別フレーズを入力してください：",
  "settings.sync": "同期",
