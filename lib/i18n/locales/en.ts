...
const en: Translations = {
  ...
  "settings.showIdentityPhrase": "Show Identity Phrase",
  "settings.hideIdentityPhrase": "Hide Identity Phrase",
  "settings.restoreIdentity": "Restore Identity",
  ...
  "settings.invalidIdentityPhrase":
    "Invalid identity phrase. Please check and try again.",
  "settings.enterIdentityPhrase": "Enter your 24-word identity phrase:",
